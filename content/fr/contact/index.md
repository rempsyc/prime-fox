...
sections:
  ...
  - block: contact-info
    content:
      ...
      contact_links:
        - icon: at-symbol
          label: remi.theriault@nyu.edu
          url: mailto:remi.theriault@nyu.edu
        - icon: brands/linkedin
          label: LinkedIn
          url: https://www.linkedin.com/in/rempsyc/
        - icon: brands/x
          label: '@RemiTPsyc'
          url: https://twitter.com/RemiTPsyc
  - block: markdown
    content:
      title: ''
      text: |-
